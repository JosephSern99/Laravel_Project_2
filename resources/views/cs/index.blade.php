...
<link rel="stylesheet" href="{{ URL::asset('css/adhoc.css?v=1.0.9') }}">

@if($channel != [])
<div class="sheet-container">
    <button class="ActionsAdhoc" id="adhoc"><div class="Adhoc">New Cases</div>
        <img class="CompassAdhoc" alt="AdhocLogo" src="{{ asset('icon/adhoc.svg?v=1.0.0') }}">
    </button>
...
@else
<div class="sheet-container">
    <button class="ActionsAdhocA" id="adhoc"><div class="Adhoc">New Cases</div>
        <img class="CompassAdhoc" alt="AdhocLogo" src="{{ asset('icon/adhoc.svg?v=1.0.0') }}">
    </button>
...
<div class="Cases container-fluid p-0" style="height:calc(100vh - 315px);">
    <table class="dataTables_wrapper" id="AdhocDatatable">
        ...
        <tbody>
                ...
                <tr>
                    <td scope="row">
                        @if( ($record->case_type == "Adhoc" or $record->case_type == "Preplanned") and empty($record->Case_AssignedUserId))
                        <a href="{!!route("vtc.aor",["id"=>$record->getKey()])!!}">
                            <div class="info-card">
                                ...
                                @if(!empty($record->Contract))
                                    @if($record->case_type == 'Adhoc' || $record->case_type == 'Preplanned')
                        ...
                        @elseif($record->case_type == "Adhoc" or $record->case_type == "Preplanned")
