...
<link rel="stylesheet" href="{{ URL::asset('css/cabling.css?v=1.0.0') }}">
...
<div class="sheet-container">
    ...
    <button class="ActionsCablingA" id="cabling"><div class="Cabling">Cabling</div>
        <img class="CompassCabling" alt="CablingLogo" src="{{ asset('icon/service-green.svg?v=1.0.0') }}">
    </button>
