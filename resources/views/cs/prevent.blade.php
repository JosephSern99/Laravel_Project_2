...
<link rel="stylesheet" href="{{ URL::asset('css/prevent.css?v=1.0.9') }}">
...
@if($channel != [])
    ...
    <button class="ActionsPrevent" id="prevent"><div class="Prevent">Preventive</div>
        <img class="CompassPrevent" alt="PreventLogo" src="{{ asset('icon/preventive_green.svg?v=1.0.0') }}">
    </button>
...
<table class="dataTables_wrapper" id="PreventDatatable">
        ...
        <tr>
            <td scope="row">
                @if($record->case_type == "Preventive" and empty($record->Case_AssignedUserId))
