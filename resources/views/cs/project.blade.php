...
<link rel="stylesheet" href="{{ URL::asset('css/project.css?v=1.0.0') }}">
...
<div class="sheet-container">
    ...
    <button class="ActionsProjectA" id="project"><div class="OnHand">Project</div>
        <img class="CompassProject" alt="ProjectLogo" src="{{ asset('icon/caselist.svg?v=1.0.0') }}">
    </button>
